...
export const mockOversiktData: OppfolgingsplanerOversiktForAG = {
  ...
  oversikt: {
    ...
    aktivPlan: {
      ...
      ferdigstiltTidspunkt: new Date("2025-10-25T09:00:00Z"),
    ...
    tidligerePlaner: [
      {
        ...
        ferdigstiltTidspunkt: new Date("2025-10-15T09:00:00Z"),
        evalueringsDato: new Date("2025-12-31"),
      ...
      },
      {
        ...
        ferdigstiltTidspunkt: new Date("2025-10-05T09:00:00Z"),
        evalueringsDato: new Date("2025-12-31"),
